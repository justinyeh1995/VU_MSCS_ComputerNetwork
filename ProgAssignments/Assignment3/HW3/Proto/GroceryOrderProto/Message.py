...
class Message(object):
    ...
    def Contents(self):
        ...
        if o != 0:
            ...
            from Proto.GroceryOrderProto.Grocery import Grocery
            obj = Grocery()
...
def MessageAddContents(builder, contents): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(contents), 0)
